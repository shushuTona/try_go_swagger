...
func (m *ErrorResponse) contextValidateCode(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ErrorResponse) contextValidateMessage(ctx context.Context, formats strfmt.Registry) error {
